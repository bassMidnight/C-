#include <iostream> 
using namespace std; 
int main() { int age = 0; /* Age of the applicant */ 
int college = 0; /* Code for college attended */ 
int subject = 0; /* Code for subject studied */ 
bool interview = false; int time = 0; /* Get data on the applicant */ 

cout << "What college? 1 = KKU, 2 = CU, 3 = other: "; 
cin >> college; cout << "What subject? 1 = Math, 2 = Physics, 3 = other: "; 
...
}else {cout << "Reject 'em" << endl; return 0; }
}